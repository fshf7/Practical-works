...
public class MinMax<T extends Comparable<T>> {
    ...
    public static void main(String[] args) {
        MinMax<Character> aChar = new MinMax<>(new Character[]{'k', 'h', 'c', 'b'});
    ...
    public static void printMinMaxInfo(MinMax<?> arr) {
        ...
        System.out.println("Min element - \'" + arr.getMinElement() + '\'');
        System.out.println("Max element - \'" + arr.getMaxElement() + '\'');
    }
}